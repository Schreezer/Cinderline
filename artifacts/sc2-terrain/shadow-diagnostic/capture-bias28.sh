...
for state in "${states[@]}"; do
  ...
  "$command_editor" "$project_root/Cinderline.uproject" -game -unattended \
    ...
    "-ExecCmds=t.MaxFPS 30,cinder.quality,r.Shadow.CSMDepthBias 28,r.Shadow.CSMSlopeScaleDepthBias 8.57,r.Shadow.CSMDepthBias,r.Shadow.CSMSlopeScaleDepthBias,cinder.canyonpreview $state" \
