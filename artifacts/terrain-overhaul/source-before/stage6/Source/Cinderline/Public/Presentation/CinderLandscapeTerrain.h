...
constexpr uint32 CliffProfileVersion = 5;

/** Low terrain support beneath the authored western-expansion rock body. */
...
/** Shared deterministic bake/scenery policy; never depends on runtime asset availability. */
