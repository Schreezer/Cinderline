...
def create_material():
    ...
    # Matching the ground's vertex fog contract prevents its still-unexplored
    ...
    above_baseline = graph.node("Rock baseline at minus one", "Add", const_b=1.0)
    ...
    result["licensed_surface_detail"] = {
        ...
        "unknown_height": {"source": "clamped FogMask G, explicit mip 0",
                           "baseline_world_z": -1.0,
                           "offset": "-(worldZ + 1) * (1 - explored G)"},
    }
